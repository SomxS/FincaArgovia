...
<form class="row" id="formDatos">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseRH" class="accordion-collapse collapse show" aria-labelledby="informacionPersonalRH"
                ...
                <div class="accordion-body row">
                    <div class="col-12 col-sm-12 col-md-2 col-lg-3 p-0 mb-3 mt-3" id="photo__colaborador">
            ...
            <div id="collapseRH2" class="accordion-collapse collapse" aria-labelledby="accordionRH2"
                ...
                <div class="accordion-body row">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 hide">
                        ...
                        <select class="form-select" id="iptPatron" aria-label="Patrón"></select>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <label for="cbUDN" class="form-label fw-bold">Ubicación laboral *</label>
                        <select class="form-select" id="cbUDN" aria-label="Ubicación laboral"></select>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
    ...
    <div class="col-12 mt-4 mb-4">
        <button type="submit" class="btn btn-primary col-12 col-sm-6 offset-sm-3 col-md-4 offset-md-4">Guardar
            información</button>
    </div>
</form>
