                        ...
                        <nav aria-label='breadcrumb'>
                            <ol class='breadcrumb'>
                                <li class='breadcrumb-item text-uppercase text-muted'>pruebas</li>
                                
                                <li class='breadcrumb-item fw-bold active'>Prueba</li>
                            </ol>
                        </nav>
                        <div class="row mb-3">
                        ...
                        <script src='src/js/prueba.js?t=1695742512'></script>
