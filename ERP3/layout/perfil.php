<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item text-muted">Plantilla</li>
        <li class="breadcrumb-item fw-bold active">Perfil</li>
    </ol>
</nav>

<div class="row col-12 p-0 bg-none d-flex justify-content-between">
    <!-- IMAGEN PERFIL / PASSWORD -->
    <div class="col-12 col-md-4 mb-3 mb-md-0 rounded-3 bg-light">
    ...
    <!-- INFORMACIÓN -->
    <div class="col-12 col-md-7 rounded-3 bg-light">
        <form class="row col-12 p-2">
